...
invisibleGround = createSprite(0, windowHeight/2 + 70, 1000, 6)
...
function spawnlava() {
    if(frameCount % 150 === 0){
        lava = createSprite(4000 - ground.velocityX, height /2 + 104, 180, 80)
...
function spawnObstacles() {
    if(frameCount % 100 === 0) {
      var obstacle = createSprite(2000 - ground.velocityX,height - 385,20,30);
